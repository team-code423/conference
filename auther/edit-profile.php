...
<div class="container">
    <form action="update.php" method="POST">
        ...
        <input type="text" name="fname" placeholder="First Name" style="width: 25%" value="<?= $_SESSION['fname']; ?>" >
        <input type="text" name="lname"placeholder="Last Name" style="width: 25%" value="<?= $_SESSION['lname']; ?>"> <br><br>
        ...
        <input type="number" name="group" style="width: 28%" value="<?= $_SESSION['group']; ?>"> <br><br>
        ...
        <label> Company* </label>
        <input type="text" name="company" style="width: 30%" value="<?= $_SESSION['company']; ?>"> <br><br>


        <label> Faculty* </label>
        <input type="text" name="faculty" style="width: 40%" value="<?= $_SESSION['faculty']; ?>"> <br><br>

        <label> Department* </label>
        <input type="text" name="department" style="width: 40%" value="<?= $_SESSION['dep']; ?>"> <br><br>
        ...
        <textarea name="address"> <?= $_SESSION['address']; ?></textarea> <br><br>

        <label> State/Province* </label>
        <input type="text" name="state" style="width: 28%" value="<?= $_SESSION['state']; ?>"> <br><br>

        <label> Country* </label>
        <select class="menu2" name="country">

            <option selected value="<?= $_SESSION['country']; ?>"> <?= $_SESSION['country']; ?> </option>
        ...
        <input type="tel" name="mobile" style="width: 28%" <?= $_SESSION['phone']; ?> <br><br>
